...
-- Telegram webhook updates are durably queued before Gemini analysis. The
-- unique chat/message pair and the transaction that creates an expense make
-- Telegram retries idempotent.
